...
const Products = ({img, name, description, price}) =>{
    return(
        ...
        */}
        {/* Props estructurados. Puedo asignar diferentes propiedades a un div, sintener que generar muchos props, solamente usando la palabra reservada "props"  como parametro de la función.
        *Quiero modificar varias propiedades, puedo mandar a llamar las props dentro de cada elemnto, como si fueran metodos.
        */}
