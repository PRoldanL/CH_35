...
Se deben establecer dos grupos de métodos

	Grupo 1: métodos booleanos para determinar a que tipo de caracteres corresponde
...
public class Contador {
	...
	//Casteo: Cambio de un dato a otro 
