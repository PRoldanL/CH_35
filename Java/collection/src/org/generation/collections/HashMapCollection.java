...
public class HashMapCollection {
	public static void main(String[] args) {
		...
		for (Map.Entry <String, String> entry: capitals.entrySet()) {			
			...
			//Mostrar la clave (.getKey()) y el valor (.getValue()) de forma individual para su manipulación
		...
		calificaciones.put("a", 4);
		calificaciones.put("b", 5);
		calificaciones.put("c", 6);
		calificaciones.put("d", 7);
		calificaciones.put("e", 8);
		calificaciones.put("f", 9);
		calificaciones.put("g", 10);
		
		for (Map.Entry <String, Integer> entry: calificaciones.entrySet()) {
			
	//Mostrar la clave (.getKey()) y el valor (.getValue()) de forma individual para su manipulación
			
			System.out.println("* La calificación de " + entry.getKey() + " es " + entry.getValue()+".");
